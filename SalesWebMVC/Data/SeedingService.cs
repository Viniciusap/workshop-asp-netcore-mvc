...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Thamiris Mule", "thamirismule@gmail.com", new DateTime(2989, 10, 25), 3000, d1);
            Seller s3 = new Seller(3, "Jubileu da Silva", "jubileu@aol.com", new DateTime(1993, 01, 19), 1000, d4);
            ...
            SalesRecord r3 = new SalesRecord(3, new DateTime(2018, 09, 13), 4000.0, SaleStatus.Canceled, s2);
            ...
            SalesRecord r13 = new SalesRecord(13, new DateTime(2018, 09, 29), 10000.0, SaleStatus.Billed, s2);
            SalesRecord r14 = new SalesRecord(14, new DateTime(2018, 09, 4), 3000.0, SaleStatus.Billed, s1);
            SalesRecord r15 = new SalesRecord(15, new DateTime(2018, 09, 12), 4000.0, SaleStatus.Billed, s2);
            ...
            SalesRecord r18 = new SalesRecord(18, new DateTime(2018, 10, 24), 6000.0, SaleStatus.Billed, s2);
            SalesRecord r19 = new SalesRecord(19, new DateTime(2018, 10, 22), 8000.0, SaleStatus.Billed, s1);

            Product p1 = new Product(1, "Mouse", 22.0, "Periférico");
            Product p2 = new Product(2, "Caneta", 2.0, "Suplemento");
            Product p3 = new Product(3, "Monitor", 340.0, "Peça");
            ...
            _context.Product.AddRange(p1, p2, p3);
